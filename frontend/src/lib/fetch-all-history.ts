...
export async function fetchAllTransactions(type: 'OUTWARD' | 'INWARD'): Promise<Transaction[]> {
...
export async function fetchAllAccountEntries(): Promise<AccountingEntry[]> {
...
export async function fetchAllHawalaEntries(): Promise<HawalaEntry[]> {
...
export async function fetchAllSpecialEntries(): Promise<SpecialEntry[]> {
...
export async function fetchAllModuleHistoryData(): Promise<ModuleHistoryData> {
